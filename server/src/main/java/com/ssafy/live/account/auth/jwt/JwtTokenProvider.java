...
public class JwtTokenProvider {
    ...
    private static final long ACCESS_TOKEN_EXPIRE_TIME = 60 * 1000L;             // 30분 30 * 60 * 1000L test 1분
    private static final long REFRESH_TOKEN_EXPIRE_TIME = 3 * 60 * 1000L;    // 7일 7 * 24 * 60 * 60 * 1000L test 3분
